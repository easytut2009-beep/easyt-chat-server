...
+'#zg-quiz-body{flex:1;overflow-y:auto;padding:55px 20px 20px;display:flex;flex-direction:column;align-items:center}'
/* Quiz count screen */
...
+'.zg-start-btn{width:85%;display:flex;align-items:center;justify-content:center;background:#198754;color:#fff;border:none;border-radius:14px;padding:28px 6px;font-size:14px;font-weight:700;cursor:pointer;font-family:Tahoma,Geneva,sans-serif;gap:8px}'
