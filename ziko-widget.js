...
+'#zg-chat-box{position:fixed;width:400px;max-width:95vw;height:80vh;max-height:680px;min-height:380px;background:#E9ECEB;border-radius:18px;box-shadow:0 16px 50px rgba(0,0,0,0.22);display:none;overflow:hidden;direction:rtl;z-index:10000;opacity:0;transform:scale(0.92);transition:opacity .25s ease,transform .25s ease;pointer-events:auto;flex-direction:column;position:relative}'
...
+'#zg-header{background:linear-gradient(135deg,#0F5132 0%,#0B3D2E 100%);color:#FFFFFF;padding:8px 14px;display:flex;justify-content:space-between;align-items:center;min-height:46px;flex-shrink:0;cursor:grab;user-select:none;z-index:10001;touch-action:none;direction:rtl;border-radius:18px 18px 0 0}'
...
+'#zg-tools-menu{display:none;position:absolute;top:0;left:0;right:0;bottom:0;width:100%;height:100%;background:#fff;z-index:1000;flex-direction:column;overflow:hidden;border-radius:0;transform-origin:top center;transform:scale(0);opacity:0;transition:transform .25s cubic-bezier(0.34,1.56,0.64,1),opacity .2s ease}'
