...
- "ازاى ابني موقع" → type=search, keywords: ["html", "css", "wordpress", "تصميم مواقع"]
- "ازاى اعمل تطبيق" → type=search, keywords: ["flutter", "android", "تطبيقات"]
- "عايز اشتغل في صناعة الفيديو" → type=search, keywords: ["مونتاج", "فيديو", "موشن", "بريمير"]
