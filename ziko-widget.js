...
+'#zg-tools-menu{display:none;position:absolute;top:46px;left:0;right:0;bottom:38px;background:#fff;z-index:1000;flex-direction:column;overflow:hidden;border-radius:0;position:absolute;transform-origin:top right;transform:scale(0);opacity:0;transition:transform .25s cubic-bezier(0.34,1.56,0.64,1),opacity .2s ease}'
...
+'#zg-back-btn{width:32px;height:32px;border-radius:50%;background:#0F5132;border:none;cursor:pointer;display:none;align-items:center;justify-content:center;flex-shrink:0;order:10}'
...
/* Quiz styles */
+'#zg-quiz-overlay{position:absolute;top:46px;left:0;right:0;bottom:38px;background:#E9ECEB;z-index:1000;display:none;flex-direction:column;direction:rtl;overflow:hidden;position:absolute}'
+'#zg-quiz-overlay.zg-quiz-open{display:flex}'
+'#zg-ex-overlay{position:absolute;top:46px;left:0;right:0;bottom:38px;background:#fff;z-index:1000;display:none;flex-direction:column;direction:rtl;overflow:hidden;position:absolute}'
...
+'#zg-ex-body{flex:1;overflow-y:auto;padding:14px;min-height:0}'
