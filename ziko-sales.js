...
⚠️ diplomas_list بس لو الرسالة فيها كلمة "دبلوم" صراحةً — لو مفيش كلمة دبلوم → type=search
...
🚨 "تصوير احترافي" → type=search, keywords: ["تصوير"] — مش diplomas_list
🚨 "تصميم جرافيك" → type=search — مش diplomas_list
🚨 أي طلب تعلم مهارة بدون كلمة "دبلومة" → type=search مش diplomas_list
...
🚨 "after effects / موشن / انيميشن" → search, keywords: ["after effects", "انيميشن", "موشن"]
🚨 "تطبيق / اندرويد / flutter / mobile" → search, keywords: ["اندرويد", "flutter", "تطبيقات موبايل"]
🚨 "تيك توك" → search, keywords: ["تيك توك", "tiktok", "ادز", "سوشيال ميديا"]
🚨 "هوية بصرية / brand" → search, keywords: ["هوية بصرية", "لوجو", "جرافيك"]
🚨 "الكورسات بالعربي" أو "هل الكورسات بالعربي" → type=info
🚨 "فيه شهادات" → type=info
🚨 "عايز اشتغل معاكم كمحاضر / عايز اشارك بكورس / عايز ادرس معاكم" → type=info
...
══ قواعد الـ audience ══
أطفال: لو ذكر أطفال أو عمر صغير (6 سنين، 8 سنين، 10 سنين، ابني، ابنتي، في الابتدائي، في الإعدادي، طفل، طفلة، kids)
⚠️ "طفل 6 سنين" → audience=أطفال, keywords: ["أطفال", "kids", "scratch", "برمجة أطفال"]
⚠️ "بنتي في الجامعة / ابني في الجامعة" → audience=null (مش أطفال — شباب جامعي)
...
- "هوية بصرية / brand identity" → keywords: ["هوية بصرية", "لوجو", "brand", "illustrator", "جرافيك"]
...
- "تطبيق موبايل / mobile developer / اندرويد" → keywords: ["اندرويد", "android", "flutter", "تطبيقات موبايل"]
- "تطوير تطبيقات" → keywords: ["اندرويد", "flutter", "swift", "تطبيقات موبايل"]
- "برمجة من الصفر / مبتدئ في البرمجة" → keywords: ["برمجة", "python", "بايثون", "مبتدئ"]
- "python للمبتدئين" → keywords: ["python", "بايثون", "برمجة"]
- "backend developer" → keywords: ["node", "python", "api", "backend", "قواعد بيانات"]
- "انيميشن / موشن / after effects" → keywords: ["after effects", "انيميشن", "موشن", "تحريك"]
- "نطق الانجليزي / تحسين نطق" → keywords: ["نطق", "ice breaker", "تحدث", "انجليزي"]
- "ذكاء اصطناعي / AI / ChatGPT" → keywords: ["ذكاء اصطناعي", "chatgpt", "machine learning", "python", "AI"]
- "تيك توك ادز / تيك توك للأعمال" → keywords: ["تيك توك", "tiktok", "ادز", "اعلانات", "سوشيال ميديا"]
- "سوشيال ميديا مانجر" → keywords: ["سوشيال ميديا", "محتوى", "انستجرام", "فيسبوك", "تسويق"]
...
async function smartChat(message, sessionId) {
  ...
  // لو اليوزر قال "بصفة عامة" في أي رسالة
    ...
    if (intent.audience === "أطفال" && /جامع|university|كلي/.test(message)) {
      console.log(`⚠️ GPT said audience=أطفال but message has جامعة — resetting to null`);
