...
if(D.error){overlay.parentNode&&overlay.parentNode.removeChild(overlay);if(printWin)printWin.close();addMsg("حصل خطأ: "+D.error,"bot");return;}
