...
if (hasCurrentContent && lectureTitle) {
      p += `\n\n🔴🔴🔴 تنبيه حاسم 🔴🔴🔴`;
      p += `\nالدرس الحالي هو: "${lectureTitle}"`;
      p += `\nلو لقيت المعلومة في قسم 📗 أعلاه = المحاضر اتكلم عنها في الدرس الحالي = استخدم ✅`;
      p += `\n❌ ممنوع تقول "المحاضر ما اتكلمش عنها في الدرس الحالي" لو المعلومة موجودة في 📗!`;
      p += `\n❌ ممنوع تحيل الطالب لدرس "${lectureTitle}" لأنه هو نفسه الدرس الحالي!`;
    }
