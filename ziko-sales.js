...
🎯 قاعدة عامة: لو المستخدم ذكر موضوع محدد → حط keywords مرتبطة بالموضوع ده بالعربي والإنجليزي
...
📋 أمثلة محددة للحالات الشائعة:

**تصميم وجرافيك:**
- "تصميم جداول" → ["تصميم", "جداول", "illustrator", "indesign", "excel"]
- "تصميم لوجو / logo" → ["لوجو", "logo", "شعار", "هوية بصرية", "illustrator"]
- "تصميم اعلانات / تصميم جرافيك" → ["جرافيك", "فوتوشوب", "illustrator", "تصميم"]
- "تصميم واجهات / UI/UX" → ["ui", "ux", "واجهات", "figma", "تصميم"]

**فيديو وموشن:**
- "موشن جرافيك / موشن / انيميشن" → ["موشن", "motion", "after effects", "انيميشن", "animation"]
- "مونتاج فيديو / مونتاج" → ["مونتاج", "editing", "premiere", "capcut", "فيديو"]
- "صناعة الفيديو" → ["مونتاج", "فيديو", "بريمير", "premiere", "capcut"]

**تصوير:**
- "تصوير موبايل / تصوير بالموبايل" → ["تصوير", "موبايل", "mobile", "photography", "كاميرا"]
- "تصوير احترافي" → ["تصوير", "photography", "كاميرا", "dslr", "lightroom"]

**برمجة:**
- "برمجة ألعاب / game development" → ["unity", "unreal", "ألعاب", "games", "برمجة"]
- "تطوير تطبيقات / تطبيق موبايل / mobile developer" → ["اندرويد", "android studio", "flutter", "swift", "تطبيقات"]
- "تصميم مواقع / ابني موقع / web developer" → ["html", "css", "javascript", "php", "مواقع", "wordpress"]
- "backend developer" → ["node", "python", "api", "backend", "قواعد بيانات"]
- "برمجة من الصفر / مبتدئ في البرمجة" → ["برمجة", "python", "scratch", "كيف تبدأ"]

**تسويق:**
- "تسويق رقمي / ازود مبيعاتي" → ["تسويق", "facebook ads", "سوشيال ميديا", "seo", "إعلانات"]
- "media buyer" → ["فيسبوك ادز", "إعلانات", "media buyer", "تسويق"]
- "ازود متابعين / سوشيال ميديا" → ["سوشيال ميديا", "إنستجرام", "محتوى", "تسويق"]
- "كتابة محتوى" → ["كتابة محتوى", "copywriting", "سوشيال ميديا", "تسويق"]

**أعمال وإدارة:**
- "ابدأ مشروعي" → ["ريادة أعمال", "مشروع", "startup", "إدارة"]
- "محاسبة" → ["محاسبة", "اكسيل", "excel", "قوائم مالية"]

**مهارات مكتبية:**
- "اتعلم اوفيس / Office" → ["word", "excel", "powerpoint", "اوفيس", "office"]
- "إكسيل / Excel" → ["excel", "اكسيل", "جداول"]

**ذكاء اصطناعي:**
- "الذكاء الاصطناعي / AI" → ["ذكاء اصطناعي", "chatgpt", "python", "machine learning", "ai"]
...
**دبلومات:**
- "عايز دبلومة في البرمجة" → ["دبلومة برمجة", "python", "تطوير"]
- "عايز دبلومة في التصميم" → ["دبلومة جرافيك", "تصميم", "فوتوشوب"]
- "دبلومة الذكاء الاصطناعي" → ["دبلومة ذكاء اصطناعي", "chatgpt", "machine learning"]

**لغات:**
- "نطق الانجليزي / تحسين نطق" → ["نطق", "ice breaker", "تحدث", "انجليزي"]
