...
var _dcIsContentQ = /(فيها?\s*(ايه|إيه|اية|ايش|شو|كورس|دور)|محتو[يى]|كورسات\s*(ال)?دبلوم|دورات\s*(ال)?دبلوم|دبلوم[ةه]?\s*(فيها?|محتو)|ابد[أا]\s*(في\s*)?.*دبلوم|دبلوم.*ابد[أا]|ترتيب.*دبلوم|دبلوم.*ترتيب|مسار.*دبلوم|دبلوم.*مسار|ازاي\s*(ادرس|اتعلم|ابدا|ابدأ).*دبلوم|(ايه|إيه|اية)\s*.*(كورس|دور).*دبلوم|(كورسات|دورات).*(موجود|في|فى|ضمن|جو[هة]).*دبلوم|(عاوز|عايز|محتاج).*(كورس|دور).*دبلوم|دبلوم.*(كورسات|دورات))/.test(_dcNorm);
...
.replace(/(ال)?(فيها?|محتو[يى]|كورسات|دورات|ابد[أا]|ابدء|ترتيب|مسار|خطوات|ازاي|ادرس|اتعلم|عايز|عاوز|محتاج|اعرف|قولي|وريني|ايه|إيه|اية|ايش|شو|دي|ده|دا|هيه|هيا|هو|هي|اللي|بتاع[ةه]?|في|فى|عن|من|اى|أي|انهي|أنهي|جو[هة]|ضمن|موجود[ةه]?|تابع[ةه]?)\s*/g, '')
        .replace(/\s+/g, ' ')
        .trim();
