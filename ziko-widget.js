...
+'#zg-header{background:linear-gradient(135deg,#0F5132 0%,#0B3D2E 100%);color:#FFFFFF;padding:8px 14px;display:flex;justify-content:space-between;align-items:center;min-height:46px;flex-shrink:0;cursor:grab;user-select:none;position:relative;z-index:10001;touch-action:none;direction:rtl}'
...
+'#zg-ctx-banner{background:linear-gradient(135deg,#E5EDE8,#D8E8DE);border-bottom:1px solid #C4D9CC;padding:6px 0 0 0 !important;display:flex;flex-direction:column;gap:6px;direction:rtl;flex-shrink:0;position:relative;overflow:visible;z-index:10001}'
...
+'#zg-tools-menu{display:none;position:absolute;top:0;left:0;right:0;bottom:0;background:#fff;z-index:9999;flex-direction:column;overflow:hidden;border-radius:0;transform-origin:top right;transform:scale(0);opacity:0;transition:transform .25s cubic-bezier(0.34,1.56,0.64,1),opacity .2s ease}'
...
+'#zg-input-area{padding:8px 12px !important;background:#E9ECEB !important;flex-shrink:0;border-top:1px solid #d0d0d0;position:relative;z-index:10001}'
...
+'#zg-footer{background:linear-gradient(135deg,#0F5132,#0B3D2E);padding:6px 12px;padding-bottom:max(6px,env(safe-area-inset-bottom));display:flex;justify-content:space-between;align-items:center;direction:rtl;flex-shrink:0;border-radius:0 0 18px 18px;position:relative;z-index:10001}'
...
+'.zg-rz-handle{position:absolute;z-index:10002;background:transparent;touch-action:none}'
