...
+'#zg-header{background:linear-gradient(135deg,#0F5132 0%,#0B3D2E 100%);color:#FFFFFF;padding:8px 14px;display:flex;justify-content:space-between;align-items:center;min-height:46px;flex-shrink:0;cursor:grab;user-select:none;position:relative;z-index:300;touch-action:none;direction:rtl}'
...
+'#zg-ctx-banner{background:linear-gradient(135deg,#E5EDE8,#D8E8DE);border-bottom:1px solid #C4D9CC;padding:6px 0 0 0 !important;display:flex;flex-direction:column;gap:6px;direction:rtl;flex-shrink:0;position:relative;overflow:visible;z-index:300}'
...
+'#zg-tools-menu{display:none;position:absolute;top:46px;left:0;right:0;bottom:32px;background:#fff;z-index:9999;flex-direction:column;overflow:hidden;border-radius:0;transform-origin:top right;transform:scale(0);opacity:0;transition:transform .25s cubic-bezier(0.34,1.56,0.64,1),opacity .2s ease}'
...
+'#zg-footer{background:linear-gradient(135deg,#0F5132,#0B3D2E);padding:6px 12px;padding-bottom:max(6px,env(safe-area-inset-bottom));display:flex;justify-content:space-between;align-items:center;direction:rtl;flex-shrink:0;border-radius:0 0 18px 18px;position:relative;z-index:300}'
...
/* Quiz styles */
+'#zg-quiz-overlay{position:absolute;top:46px;left:0;right:0;bottom:32px;background:#E9ECEB;z-index:200;display:none;flex-direction:column;direction:rtl;overflow:hidden}'
+'#zg-quiz-overlay.zg-quiz-open{display:flex}'
+'#zg-ex-overlay{position:absolute;top:46px;left:0;right:0;bottom:32px;background:#fff;z-index:200;display:none;flex-direction:column;direction:rtl;overflow:hidden}'
...
+'<div id="zg-ex-hdr"><span id="zg-ex-title">تمرين عملي</span><button id="zg-ex-close"><svg viewBox="0 0 24 24"><path d="M18 6L6 18M6 6l12 12"/></svg></button></div>'
