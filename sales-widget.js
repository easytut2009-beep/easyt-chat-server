...
body: JSON.stringify({ message: sentText, session_id: getSessionId(), user_id: sessionId, image_base64: imgBase64Temp, image_type: imgTypeTemp })
...
body: JSON.stringify({ message: sentText, session_id: getSessionId(), user_id: sessionId })
