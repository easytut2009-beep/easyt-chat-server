...
+'#zg-chat-box .zg-lvl-btn{font-size:11px!important}'
+'#zg-chat-box .zg-msg{font-size:15px!important}'
+'#zg-chat-box .zg-bot pre{font-size:12px!important}'
+'#zg-chat-box .zg-bot code{font-size:12px!important}'
+'#zg-chat-box .zg-sugg-btn{font-size:13px!important}'
+'.zg-typing-text{font-size:13px!important}'
+'#zg-counter{font-size:11px!important}'
+'.zg-q-text{font-size:14px!important}'
+'.zg-q-opt{font-size:13px!important}'
+'.zg-q-opt-letter{font-size:12px!important}'
+'.zg-q-feedback{font-size:12px!important}'
+'.zg-next-btn{font-size:13px!important}'
+'.zg-result-grade-text{font-size:17px!important}'
+'.zg-result-grade-sub{font-size:12px!important}'
+'.zg-result-msg{font-size:12px!important}'
+'.zg-r-btn-retry{font-size:12px!important}'
+'.zg-r-btn-done{font-size:12px!important}'
+'.zg-result-of{font-size:11px!important}'
+'.zg-r-bar-label{font-size:11px!important}'
+'.zg-r-bar-num{font-size:12px!important}'
+'.zg-progress-q{font-size:12px!important}'
+'.zg-progress-pct{font-size:11px!important}'
+'.zg-count-title{font-size:15px!important}'
+'.zg-count-sub{font-size:12px!important}'
+'.zg-count-lbl{font-size:10px!important}'
+'.zg-start-btn{font-size:14px!important}'
+'.zg-info-title{font-size:14px!important}'
+'.zg-info-head{font-size:13px!important}'
+'.zg-glossary-title{font-size:14px!important}'
+'.zg-glossary-term{font-size:13px!important}'
+'.zg-glossary-def{font-size:12px!important}'
+'}';
