...
if (_isSubDiplomas) {
  ...
  _subDipReply += `كل الدورات الموجودة داخل كل الدبلومات هتلاقيها ضمن اشتراكك العام ✅<br><br>`;
  _subDipReply += `📌 <b>الخطوات:</b><br>`;
  _subDipReply += `1️⃣ اختار <b>"دورات"</b> من القائمة الرئيسية<br>`;
  _subDipReply += `2️⃣ ابحث عن الكورس الموجود داخل أي دبلومة عايز تدرسها<br>`;
  _subDipReply += `3️⃣ هتلاقي كل الكورسات متاحة ليك 🎉<br><br>`;
  _subDipReply += `💡 <b>ملحوظة:</b> الدبلومات نفسها كباقة مش بتظهر في الاشتراك العام، لكن كل الكورسات اللي جواها متاحة ليك من قسم "دورات"`;
