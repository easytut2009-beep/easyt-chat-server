...
- "عايز دبلومة في البرمجة" → keywords: ["دبلومة", "برمجة", "python"]
- "عايز دبلومة في التصميم" → keywords: ["دبلومة", "جرافيك", "تصميم"]
- "دبلومة الذكاء الاصطناعي" → keywords: ["دبلومة", "ذكاء اصطناعي", "chatgpt", "ai"]
- "عايز اشتغل كمحاضر / اضيف كورس" → type=info مع direct_reply يوجهه لـ https://easyt.online/p/author
- "بنتي في الجامعة وعايزة تتعلم" → type=clarify اسألها عن المجال
- "طبيب وعايز اتعلم" → type=clarify اسأله عن الموضوع
- "انيميشن" → keywords: ["انيميشن", "animation", "after effects", "موشن", "تحريك"]
- "نطق الانجليزي / تحسين نطق" → keywords: ["نطق", "تحدث", "انجليزي", "ice breaker"]
- "تصوير الموبايل / تصوير بالموبايل" → keywords: ["تصوير", "موبايل", "photography"]
- "اربح من الانترنت" → type=clarify اسأل عن المجال المفضل
⚠️ لا كلمات جزئية وحدها زي "داخلي" أو "متقدم"
🚫 ممنوع keywords عامة زي: احترافي، شامل، كامل — موجودة في كل الكورسات`;
