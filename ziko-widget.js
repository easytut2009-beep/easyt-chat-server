...
+'#zg-quiz-body{flex:1;overflow-y:auto;padding:30px 20px}'
/* Quiz count screen */
+'.zg-count-title{font-size:13px;font-weight:700;color:#0F5132;text-align:center;margin-bottom:12px}'
+'.zg-count-sub{font-size:10px;color:#9ca3af;text-align:center;margin-bottom:28px}'
+'.zg-count-row{display:flex;gap:20px;justify-content:center;margin-bottom:28px}'
...
+'.zg-start-btn{width:100%;background:#198754;color:#fff;border:none;border-radius:14px;padding:14px;font-size:12px;font-weight:700;cursor:pointer;font-family:Tahoma,Geneva,sans-serif;display:flex;align-items:center;justify-content:center;gap:6px}'
