...
قواعد النوع:
- type=search: لو بيدور على كورس أو برنامج محدد أو مصطلح تقني (workflow, excel, python, إلخ) أو لو قال "كورس في" أو "عايز أتعلم X" أو "فين كورس" أو "في كورسات"
- type=info: لو بيسأل سؤال تعليمي أو استشاري زي "ازاى اعمل X" أو "إيه أحسن طريقة" أو "فرق بين X وY" أو "شرحلي X" — مش بيدور على كورس
- type=clarify: لو ذكر مهنة أو هدف عام بدون تحديد ماذا يريد تعلمه — اسأل سؤال واحد ذكي
- type=support: لو عنده مشكلة تقنية في الموقع أو الكورس
