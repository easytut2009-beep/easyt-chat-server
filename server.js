...
// ══════════════════════════════════════
    ...
    // ═══ الخطوة 2: دروس أخرى ═══
    p += `\n\n📌 الخطوة 2: لو مش في الدرس الحالي → ابحث في الدروس الأخرى (📚)`;
    if (hasOtherContent) {
    ...
    p += `\n"الخطوة اللي بعد كده هتلاقيها في درس 'رفع المنتجات المستهدفة في السيلز فانل' في الدقيقة 5:20 ⏱️ — هناك هتتعلم إزاي تضيف المنتجات بشكل صحيح وتربطها بالسيلز فانل بتاعك."`;
    p += `\n   ❌ غلط: "في درس 'رفع المنتجات'. في الدرس ده هتتعلم..."`;
    p += `\n   ✅ صح: "في درس 'رفع المنتجات' — هناك هتتعلم..."`;
    p += `\n\n🟢 مثال 3 — المعلومة من معرفتك + ترشيح كورس (رابط فعلي):`;
    ...
    p += `\n\n🔴 لاحظ في المثال 3: الطالب قال 'التسويق بالبريد الإلكتروني' والكورس اسمه 'ايميل ماركيتنج'`;
