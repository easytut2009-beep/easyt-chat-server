...
if (lectureTitle) {
      ...
      p += `\n┃`;
      p += `\n┃ 🔴🔴🔴 القاعدة الأهم في البرومبت كله — "الدرس ده":`;
      p += `\n┃ الطالب حالياً واقف على الدرس ده وشايف اسمه قدامه في الصفحة.`;
      p += `\n┃ ❌ ممنوع نهائياً تذكر اسم الدرس "${lectureTitle}" — قول "الدرس ده" أو "الدرس اللي أنت فيه"`;
      p += `\n┃ ❌ ممنوع تذكر اسم الكورس "${courseName}" لو بترد عن نفس الكورس — قول "الكورس ده"`;
      p += `\n┃ ✅ "في الدرس ده عند الدقيقة 5:30 ⏱️ المحاضر شرح..."`;
      p += `\n┃ ❌ "في درس أساسيات Wireshark المحاضر شرح..." ← غلط!`;
      p += `\n┃`;
...
p += `\n┃    ❌ ما تذكرش اسم الدرس ولا اسم الكورس — الطالب شايفهم قدامه في الصفحة`;
    p += `\n┃    مثال: "في الدقيقة 11:51 من الدرس ده ⏱️ اتشرح إزاي تبني..."`;
    p += `\n┃`;
p += `\n┃ 📍 الحالة 2: المعلومة من درس تاني في نفس الكورس (📚)`;
    p += `\n┃    ✅ اذكر اسم الدرس التاني + التوقيت`;
    p += `\n┃    ❌ ما تذكرش اسم الكورس "${courseName}" — الطالب أصلاً جواه`;
    p += `\n┃    ✅ قول "في الكورس ده" بدل ما تذكر اسمه`;
    p += `\n┃    مثال: "هتلاقي الموضوع ده في درس 'اسم الدرس' في الكورس ده عند الدقيقة X:XX ⏱️"`;
    p += `\n┃`;
...
if (lectureTitle) {
      p += `\n❌ ممنوع تذكر اسم الدرس الحالي "${lectureTitle}" — قول "الدرس ده" بدل اسمه`;
    }
    if (courseName) {
      p += `\n❌ ممنوع تذكر اسم الكورس "${courseName}" لو الإجابة من نفس الكورس — قول "الكورس ده"`;
    }
