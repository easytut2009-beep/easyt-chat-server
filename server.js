...
🔴 قاعدة تغيير الموضوع:
لو الرسالة عن (اشتراك/شكوى/دفع/مشكلة تقنية/موضوع جديد) → تجاهل الذاكرة تماماً وافهم الرسالة لوحدها.
لو بيكمل نفس الموضوع → استخدم الذاكرة عادي.
`;
...
1️⃣ **SEARCH** = ذكر مجال/أداة/تقنية ("عايز كورس فوتوشوب", "شرح SEO", "مين بيشرح بايثون")
...
4️⃣ **DIPLOMAS** = عايز يشوف كل الدبلومات بدون موضوع ("ايه الدبلومات عندكم")
5️⃣ **DIPLOMA_CONTENT** = سؤال عن محتوى دبلومة معينة ("ايه الكورسات في دبلومة X", "فيها ايه")
6️⃣ **COURSE_IN_DIPLOMA** = عايز يعرف كورس معين في أنهي دبلومة ("كورس X في دبلومة ايه")
7️⃣ **CATEGORIES** = طلب صريح لعرض الأقسام ("ايه الأقسام", "وريني المجالات")
8️⃣ **CHAT** = ترحيب/كلام عام/شكر/تهنئة
9️⃣ **SUPPORT** = مشكلة تقنية/شكوى/استفسار عن الدعم
