...
مثال: "فين أتعلم؟"، "وريني الكورسات"، "عندكم كورسات؟"، "ممكن تديني؟"، "موجود عندكم؟"، "عايز أتعلم X"

⚠️ **مهم جداً — الفرق بين الرغبة والطلب:**

✅ **طلب مباشر** (type=course_request):
- **"عايز أتعلم X"** ← طلب مباشر!
- "فين أتعلم X؟"
- "وريني كورسات X"
...
- **"محتاج أطور نفسي في X"** → conversational (مش واضح عايز إيه بالظبط)
- **"نفسي أبقى X"** → conversational
- **"عايز أبدأ في X"** → conversational

**القاعدة:** لو مفيش كلمة طلب صريحة (فين، وريني، عندكم، فيه، موجود، ممكن) → مش course_request
