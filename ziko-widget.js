...
+'#zg-quiz-body{flex:1;overflow-y:auto;padding:80px 20px}'
/* Quiz count screen */
...
+'.zg-start-btn{width:100%;background:#198754;color:#fff;border:none;border-radius:14px;padding:14px 40px;font-size:12px;font-weight:700;cursor:pointer;font-family:Tahoma,Geneva,sans-serif;display:flex;align-items:center;justify-content:center;gap:6px}'
...
+'</div>'
+'<button class="zg-start-btn" id="zg-quiz-start" style="margin-top:32px">'
