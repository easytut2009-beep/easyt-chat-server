...
**طلب شرح تاني** (مش فاهم / وضحلي / بطريقة تانية / اشرحلي غير كده / صعب علي):
→ "الشرح بطريقة أخرى موجود في أدوات زيكو 👆 — اضغط عليه من القائمة!"

**طلب أخطاء شائعة** (إيه الأخطاء / الناس بتغلط في إيه / common mistakes / أخطاء):
...
**طلب آخر التحديثات** (إيه الجديد / تحديثات / latest / أحدث حاجة):
