...
+'#zg-quiz-body{flex:1;overflow-y:auto;padding:55px 20px 20px;display:flex;flex-direction:column;align-items:stretch}'
/* Quiz count screen */
...
+'.zg-start-btn{width:85%;align-self:center;display:flex;align-items:center;justify-content:center;background:#198754;color:#fff;border:none;border-radius:14px;padding:28px 6px;font-size:14px;font-weight:700;cursor:pointer;font-family:Tahoma,Geneva,sans-serif;gap:8px}'
...
+'.zg-q-text{font-size:12px;font-weight:700;color:#222;line-height:1.6;margin-bottom:12px;text-align:right;width:100%}'
+'.zg-q-opts{display:flex;flex-direction:column;gap:7px}'
+'.zg-q-opt{padding:12px 16px;border-radius:10px;border:1.5px solid #e0e0e0;background:#fff;font-size:11px;color:#374151;cursor:pointer;display:flex;align-items:center;gap:10px;text-align:right;direction:rtl;transition:all .2s;font-family:Tahoma,Geneva,sans-serif;width:100%}'
