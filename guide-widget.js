...
+'#zg-notify-close{position:absolute;top:-8px;left:-8px;width:32px;height:32px;background:#fff;color:#666;border-radius:50%;border:none;cursor:pointer;display:flex;align-items:center;justify-content:center;box-shadow:0 2px 6px rgba(0,0,0,0.12);padding:0}'
...
+'#zg-header-status{font-size:11px;opacity:0.85;display:flex;align-items:center;gap:3px;direction:rtl}'
...
+'#zg-tools-btn-label{font-size:11px;font-weight:700;color:#fff;white-space:nowrap}'
+'.zg-hdr-btn{cursor:pointer;width:44px;height:44px;display:flex;align-items:center;justify-content:center;border-radius:50%;color:#fff;background:none;border:none;transition:background .2s;position:relative;z-index:12}'
...
+'#zg-ctx-banner-title{font-size:12px;font-weight:700;color:#0F5132;white-space:nowrap;overflow:hidden;text-overflow:ellipsis}'
+'#zg-ctx-banner-body{font-size:11px;color:#0F5132;margin-top:1px;white-space:nowrap;overflow:hidden;text-overflow:ellipsis}'
...
+'#zg-tools-menu-close{width:44px;height:44px;border-radius:50%;background:rgba(255,255,255,0.15);border:none;display:flex;align-items:center;justify-content:center;cursor:pointer;flex-shrink:0}'
...
+'#zg-chat-box .zg-sugg-btn{background:#D1E7DD !important;border:1.5px solid #BADBCC !important;color:#0F5132 !important;padding:6px 12px !important;border-radius:18px 18px 4px 18px !important;font-size:13px !important;font-weight:600 !important;cursor:pointer;transition:all .25s ease;white-space:nowrap !important;font-family:Tahoma,Geneva,sans-serif !important;opacity:0;animation:zgBubbleIn .4s ease forwards;box-shadow:0 1px 4px rgba(0,0,0,0.06);display:inline-flex !important;align-items:center !important;gap:5px !important}'
...
+'.zg-typing-text{font-size:13px;color:#888}'
...
+'#zg-counter{font-size:11px;color:rgba(255,255,255,0.95);font-weight:700;display:flex;align-items:center;gap:4px}'
...
+'#zg-pow{font-size:10px;color:rgba(255,255,255,0.55);font-weight:bold}'
+'.zg-rz-handle{position:absolute;z-index:10003;background:transparent;touch-action:none}'
+'#zg-back-btn{width:44px;height:44px;border-radius:50%;background:none;border:none;cursor:pointer;display:none;align-items:center;justify-content:center;flex-shrink:0;transition:background .2s;color:#fff;position:relative;z-index:12}'
...
/* Quiz styles */
+'#zg-quiz-overlay{position:absolute;top:46px;left:0;right:0;bottom:0;background:#E9ECEB;z-index:1000;display:none;flex-direction:column;direction:rtl;overflow:hidden}'
+'#zg-quiz-overlay.zg-quiz-open{display:flex}'
+'#zg-ex-overlay{position:absolute;top:0;left:0;right:0;bottom:0;background:#fff;z-index:1000;display:none;flex-direction:column;direction:rtl;overflow:hidden}'
...
+'#zg-ex-close{width:44px;height:44px;border-radius:50%;background:rgba(255,255,255,0.15);border:none;display:flex;align-items:center;justify-content:center;cursor:pointer;flex-shrink:0}'
...
+'#zg-ex-input{width:100%!important;border:1.5px solid #d0d0d0 !important;border-radius:10px !important;padding:8px 12px !important;font-size:16px !important;direction:rtl;resize:none;font-family:Tahoma,Geneva,sans-serif;min-height:60px;outline:none !important;box-shadow:none !important;background:#fff !important}'
...
+'#zg-ex-send{flex:1;background:#198754;color:#fff;border:none;border-radius:10px;padding:12px;font-size:15px;font-weight:700;cursor:pointer;font-family:Tahoma,Geneva,sans-serif}'
...
+'#zg-quiz-sub{font-size:11px;color:rgba(255,255,255,0.7);margin-top:1px}'
+'#zg-quiz-close{width:44px;height:44px;border-radius:50%;background:rgba(255,255,255,0.15);border:none;cursor:pointer;display:flex;align-items:center;justify-content:center}'
...
+'.zg-result-score{font-size:32px;font-weight:700;color:#0F5132;line-height:1}'
+'.zg-result-of{font-size:12px;color:#6b7280;margin-top:4px}'
+'.zg-result-grade{text-align:center;margin-bottom:20px}'
+'.zg-result-grade-text{font-size:18px;font-weight:700;color:#0F5132}'
+'.zg-result-grade-sub{font-size:12px;color:#9ca3af;margin-top:5px;line-height:1.6}'
+'.zg-result-bars{display:flex;flex-direction:column;gap:14px;margin-bottom:18px}'
+'.zg-r-bar-row{display:flex;align-items:center;gap:10px}'
+'.zg-r-bar-label{font-size:13px;color:#6b7280;width:38px;text-align:right;flex-shrink:0}'
+'.zg-r-bar-track{flex:1;height:10px;background:#e9eceb;border-radius:6px}'
+'.zg-r-bar-fill{height:10px;border-radius:6px}'
+'.zg-r-bar-fill.zg-green{background:#198754}'
+'.zg-r-bar-fill.zg-red{background:#ef4444}'
+'.zg-r-bar-num{font-size:14px;font-weight:700;width:20px;flex-shrink:0}'
+'.zg-r-bar-num.zg-g{color:#198754}'
+'.zg-r-bar-num.zg-r{color:#ef4444}'
+'.zg-result-msg{background:#d1e7dd;border-radius:12px;padding:12px 16px;font-size:12px;color:#0F5132;line-height:1.8;margin-bottom:18px}'
+'.zg-result-msg svg{width:14px;height:14px;stroke:#198754;fill:none;stroke-width:2;stroke-linecap:round;vertical-align:middle;margin-left:6px}'
+'.zg-result-btns{display:flex;gap:10px;margin-top:8px}'
+'.zg-r-btn-retry{flex:1;padding:18px;border-radius:14px;border:1.5px solid #198754;background:#fff;color:#198754;font-size:15px;font-weight:700;cursor:pointer;font-family:Tahoma,Geneva,sans-serif}'
+'.zg-r-btn-done{flex:1;padding:18px;border-radius:14px;border:none;background:#198754;color:#fff;font-size:15px;font-weight:700;cursor:pointer;font-family:Tahoma,Geneva,sans-serif}'
/* infographic */
...
+'#zg-chat-box .zg-lvl-btn{font-size:10px!important}'
...
var html='<div style="display:flex;flex-direction:column;justify-content:center;gap:20px;padding:20px 16px;min-height:100%;box-sizing:border-box">'
+'<div style="display:flex;justify-content:center">'
+'<div style="width:110px;height:110px;border-radius:50%;border:6px solid #198754;background:#f0faf5;display:flex;flex-direction:column;align-items:center;justify-content:center">'
+'<div style="font-size:32px;font-weight:700;color:#0F5132;line-height:1">'+score+'/'+total+'</div>'
+'<div style="font-size:12px;color:#6b7280;margin-top:4px">درجتك</div>'
+'</div></div>'
+'<div style="text-align:center">'
+'<div style="font-size:18px;font-weight:700;color:#0F5132">'+grade+'</div>'
+'<div style="font-size:12px;color:#9ca3af;margin-top:5px;line-height:1.6">'+gradeSub+'</div>'
+'</div>'
+'<div style="display:flex;flex-direction:column;gap:14px">'
+'<div style="display:flex;align-items:center;gap:10px"><div style="font-size:13px;color:#6b7280;width:38px;text-align:right;flex-shrink:0">صح</div><div style="flex:1;height:10px;background:#e9eceb;border-radius:6px"><div style="width:'+pct+'%;height:10px;background:#198754;border-radius:6px"></div></div><div style="font-size:14px;font-weight:700;color:#198754;width:20px;flex-shrink:0">'+score+'</div></div>'
+'<div style="display:flex;align-items:center;gap:10px"><div style="font-size:13px;color:#6b7280;width:38px;text-align:right;flex-shrink:0">غلط</div><div style="flex:1;height:10px;background:#e9eceb;border-radius:6px"><div style="width:'+wrongPct+'%;height:10px;background:#ef4444;border-radius:6px"></div></div><div style="font-size:14px;font-weight:700;color:#ef4444;width:20px;flex-shrink:0">'+(total-score)+'</div></div>'
+'</div>'
+'<div style="background:#d1e7dd;border-radius:12px;padding:12px 16px;font-size:12px;color:#0F5132;line-height:1.8">'+(score<total?"الأسئلة اللي غلطت فيها — راجع الدرس تاني وحاول الاختبار مرة تانية.":"أنت أجبت على كل الأسئلة صح! عظيم!")+'</div>'
+'<div style="display:flex;gap:10px">'
+'<button id="zg-quiz-retry" style="flex:1;padding:18px;border-radius:14px;border:1.5px solid #198754;background:#fff;color:#198754;font-size:15px;font-weight:700;cursor:pointer;font-family:Tahoma,Geneva,sans-serif">حاول تاني</button>'
+'<button id="zg-quiz-done" style="flex:1;padding:18px;border-radius:14px;border:none;background:#198754;color:#fff;font-size:15px;font-weight:700;cursor:pointer;font-family:Tahoma,Geneva,sans-serif">تمام، خلصت</button>'
+'</div>'
+'</div>';
$quizBody.innerHTML=html;
...
if(streamGen!==myToolGen){stopSending();return;}
if($toolsWrap){$toolsWrap.style.opacity='';$toolsWrap.style.pointerEvents='';}
if(id==="infographic"){renderInfographic(reply);sending=false;if($send){$send.classList.remove("zg-stop");$send.innerHTML=IC.send;$send.disabled=false;}}
else if(id==="glossary"){renderGlossary(reply);sending=false;if($send){$send.classList.remove("zg-stop");$send.innerHTML=IC.send;$send.disabled=false;}}
else{typewriterMsg(reply,"bot",function(){if(streamGen!==myToolGen)return;sending=false;if($send){$send.classList.remove("zg-stop");$send.innerHTML=IC.send;$send.disabled=false;}});}
})
...
function tick(){
if(typewriterActive!==myGen){m.innerHTML=h;scrollBot();return;}
