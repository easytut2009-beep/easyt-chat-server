...
5. لو المستخدم سأل عن سعر أو عرض أو كوبون ومفيش معلومة واضحة في تعليمات الأدمن → قوله "تقدر تشوف الأسعار والعروض الحالية من صفحة الاشتراك" + لينك
...
- لو تعليمات الأدمن فيها سعر أو خصم → استخدمه!
  لو مفيش → وجّه المستخدم لصفحة الاشتراك يشوف الأسعار الحالية

القاعدة: اقرأ تعليمات الأدمن الأول → لو فيه تعليمة بتجاوب → CHAT + response_message → خلاص!
` : `⚠️ مفيش تعليمات أدمن حالياً.
لو المستخدم سأل عن أسعار أو عروض أو خصومات → وجّهه لصفحة الاشتراك يشوف الأسعار الحالية.
❌ ممنوع نهائياً تخترع أي سعر أو عرض أو كوبون!
`}
...
- "الاشتراك شهري ولا سنوي" → SUBSCRIPTION (سؤال عن تفاصيل → يجاوب من تعليمات الأدمن)
...
1. لو المستخدم بيسأل عن سعر/عرض/خصم/كوبون:
   → جاوبه من تعليمات الأدمن لو فيها المعلومة
   → لو مفيش في تعليمات الأدمن → قوله "تقدر تشوف الأسعار والعروض الحالية من صفحة الاشتراك" + لينك
...
3. لو عايز يشترك مباشرة:
   → ادّيله المميزات + لينك الاشتراك + لينك طرق الدفع
   → لو فيه عرض/خصم في تعليمات الأدمن → اذكره
   → لو مفيش → متذكرش أسعار — خلّيه يشوفها في صفحة الاشتراك
...
⚠️⚠️⚠️ الأسعار والعروض والخصومات والكوبونات → موجودة في تعليمات الأدمن فوق بس!
❌ ممنوع تخترع أسعار أو عروض أو خصومات أو كوبونات من عندك نهائياً!
❌ ممنوع تذكر أي رقم سعر إلا لو مكتوب صراحةً في تعليمات الأدمن!
✅ لو مفيش سعر في تعليمات الأدمن → قول "تقدر تشوف الأسعار والعروض الحالية من صفحة الاشتراك" + لينك
