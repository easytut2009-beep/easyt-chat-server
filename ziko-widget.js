...
+'.zg-result-btns{display:flex;gap:10px}'
+'.zg-r-btn-retry{flex:1;padding:13px;border-radius:12px;border:1.5px solid #198754;background:#fff;color:#198754;font-size:13px;font-weight:700;cursor:pointer;font-family:Tahoma,Geneva,sans-serif}'
+'.zg-r-btn-done{flex:1;padding:13px;border-radius:12px;border:none;background:#198754;color:#fff;font-size:13px;font-weight:700;cursor:pointer;font-family:Tahoma,Geneva,sans-serif}'
/* infographic */
