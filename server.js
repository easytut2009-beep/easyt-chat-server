...
// ══════════════════════════════════════
    ...
    p += `\n┃    مثال: "في درس [اسم الدرس] في الدقيقة X:XX ⏱️ اتشرح..."`;
    p += `\n┃`;
    p += `\n┃ 📍 الحالة 3: المعلومة من كورس تاني (🎓)`;
    p += `\n┃    ✅ اذكر اسم الكورس + اسم الدرس + التوقيت لو متاح`;
    p += `\n┃    مثال: "هتلاقي الموضوع ده في كورس [اسم الكورس] في درس [اسم الدرس] في الدقيقة X:XX ⏱️"`;
    p += `\n┃`;
    ...
    p += `\n📋 أمثلة على الرد المثالي:`;
    p += `\n══════════════════════════════════════`;
    p += `\n\n🟢 مثال 1 — المعلومة في الدرس الحالي (تايم ستامب + بدون اسم الدرس):`;
    ...
    p += `\n\n🟢 مثال 2 — المعلومة في درس تاني (اسم الدرس + تايم ستامب):`;
    p += `\n"الموضوع ده اتشرح في درس 'اختيار المنصة المناسبة' في الدقيقة 5:20 ⏱️ — هناك اتوضّح الفرق بين المنصات وإزاي تختار الأنسب ليك."`;
