...
// ═══════════════════════════════════════════════════════════
    ...
    if (otherCourseRecommendation) {
      ...
      p += `\n   "هتلاقي الموضوع ده بالتفصيل في كورس [اسم الكورس] في درس [اسم الدرس] في الدقيقة X:XX ⏱️"`;
      p += `\n   🔗 [رابط الكورس]`;
      if (otherCourseRecommendation.lessons && otherCourseRecommendation.lessons.length > 0) {
        p += `\n   📖 واذكر الدروس المحددة والتوقيتات لو موجودة`;
      }
    ...
    p += `\n"الموضوع ده اتشرح في درس [اختيار المنصة المناسبة] في الدقيقة 5:20 ⏱️ — هناك المحاضر وضّح الفرق بين المنصات وإزاي تختار الأنسب ليك."`;
    p += `\n\n🟢 مثال 3 — المعلومة من معرفتك (بدون توقيت):`;
    p += `\n"الـ Upsell هو إنك تعرض على العميل منتج أغلى أو إضافي بعد ما ياخد قرار الشراء. ده بيزوّد متوسط قيمة الطلب بشكل كبير. أحسن وقت تعرض فيه الـ upsell هو بعد ما العميل يضيف المنتج للسلة وقبل ما يدفع."`;
