...
**قواعد الـ keywords:**
- استخدم **الكلمات الفعلية** اللي المستخدم قالها في الحوار
- لو ذكر أداة أو تقنية بالاسم → استخدمها كما هي
- لو ذكر مجال → استخدم المصطلحات المتعلقة بيه من سياق الحوار
- لو ذكر مشكلة (مثلاً ضعف لغة) → ابحث عن حلها
