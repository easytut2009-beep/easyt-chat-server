...
- ما تحلش امتحانات أو assignments كاملة`;
    ...
    p += `\n\n📌 الخطوة 3: لو مش موجود في أي محتوى`;
    p += `\n   - قول: "❌ الموضوع ده مش موجود في محتوى الدروس المتاحة عندي حالياً"`;
    if (!hasCurrentContent && !hasOtherContent) {
      p += `\n   - قول: "محتوى الدرس ده محتاج يترفع الأول عشان أقدر أساعدك"`;
    }
    p += `\n   - ❌ ممنوع تشرح من معرفتك العامة!`;
    p += `\n   - ❌ ممنوع تقول "خليني أشرحلك" وتجيب كلام من بره المحتوى!`;
    ...
    p += `\n❌ ممنوع تجيب معلومات من بره المحتوى المكتوب فوق`;
